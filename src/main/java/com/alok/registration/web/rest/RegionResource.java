...
import com.alok.registration.service.RegionService;
...
/**
 * REST controller for managing {@link com.alok.registration.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "registrationServiceRegion";
